...
namespace JJNG.Web.Areas.Finance.Controllers
{
    ...
    public class FncFrontCalendar2Controller : Controller
    {
        private readonly AppDbContext _context;
        private readonly AppIdentityDbContext _identityContext;
        private UserManager<AppIdentityUser> _userManager;

        public FncFrontCalendar2Controller(AppDbContext context, AppIdentityDbContext identitycontext, UserManager<AppIdentityUser> usrMgr)
        {
            _context = context;
        ...
        public async Task<ActionResult> Index(string branchName = "既见·南国", int branchId = 2)
        {
            ...
            #region 房号去文字
            //var templist = _context.BrhFrontDeskAccounts.Where(x => x.Branch == "既见·欢喜" && x.HouseNumber.Length > 3).ToList();
            //foreach(var t in templist)
            //{
            //    t.HouseNumber=Regex.Replace(t.HouseNumber, @"[^\d]*", "");
            //}
            ...
            //    brhFrontDeskAccounts.Branch = "既见·苍海";
            ...
            //    brhFrontDeskAccounts.Count = (t.退房时间 - t.到店时间).Days;
            //    if (brhFrontDeskAccounts.Count != 0)
            //        brhFrontDeskAccounts.UnitPrice = t.房费 / brhFrontDeskAccounts.Count;
            //    else
            //        brhFrontDeskAccounts.UnitPrice = t.房费;
            ...
            //    }
            //    if (test == 0)
            //        brhFrontDeskAccounts.Color = "gray";
