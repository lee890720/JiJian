...
namespace JJNG.Web.Areas.Branch.Controllers
{
    ...
    public class BrhCollectController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(Tuple.Create<BrhConnectRecord,List<BrhMemo>,BrhImprestAccounts,List<BrhFrontDeskAccounts>,FncBranch>(connectRecord,brhMemoList,brhImprestAccount,brhFrontDeskAccounts,fncBranch));
        }
