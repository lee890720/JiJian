...
namespace JJNG.Web.Areas.Branch.Controllers
{
    ...
    public class BrhNoteAccountController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var psnNoteAccount = await _context.PsnNoteAccount.Where(x => x.BelongTo == _user.BelongTo && x.Department == _user.Department&&(string.IsNullOrEmpty(x.Manager)||x.Manager==_user.UserName)).ToListAsync();
