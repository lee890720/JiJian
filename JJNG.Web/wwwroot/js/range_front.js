...
$.fn.dataTable.ext.search.push(
    function (settings, data, dataIndex) {
        ...
        var iData2 = data[iDateCol2].substring(0, 4) + data[iDateCol2].substring(5, 7) + data[iDateCol2].substring(8, 10);
        ...
        else if (iEnd >= iData2 && iStart === "") {
            return true;
        }
        else if (!(iStart >= iData2 || iEnd <= iData)) {
            return true;
        }
        return false;
    }
